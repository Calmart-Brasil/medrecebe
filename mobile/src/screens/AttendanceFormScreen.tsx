...
const styles = StyleSheet.create({
  ...
  quantityRow: { alignItems: 'center', borderTopColor: colors.line, borderTopWidth: 1, flexDirection: 'row', flexWrap: 'wrap', gap: 9, padding: 11 },
  ...
  quantityTotal: { color: colors.blue700, fontSize: 12, fontWeight: '900', textAlign: 'right', width: '100%' },
